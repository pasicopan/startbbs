...
<?php }?>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
						<form accept-charset="UTF-8" action="<?php echo site_url('topic/add')?>" id="new_topic" method="post" novalidate="novalidate" name="add_new" class="form-horizontal">
						...
						<input name="node_id" type="hidden" value="1" />
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 ">
                                <input class="form-control" id="topic_title" name="title" type="text" placeholder="标题" value="<?php echo set_value('title');?>" />
                              </div>
                              <div class="col-sm-3">
                            ...
                            <div class="form-group" id="textContain">
                                <textarea style="display:none;" class="form-control" id="post_content" name="content" placeholder="话题内容" rows="10"><?php echo set_value('content'); ?>
</textarea>
